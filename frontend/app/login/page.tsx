      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          {justRegistered && !error && (
            <div className="mb-4 p-3 rounded-lg bg-success-50 border border-success-200 text-success-600 text-sm dark:bg-success-500/10 dark:border-success-500/30 dark:text-success-400">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-5 h-5 rounded-md border-gray-300 text-brand-500 focus:ring-brand-500 cursor-pointer appearance-none border checked:bg-brand-500 checked:border-transparent dark:border-gray-700"
                    />
                    <label htmlFor="keepLoggedIn" className="block font-normal text-gray-700 text-sm dark:text-gray-400 cursor-pointer">
                      Keep me logged in
                    </label>
                  </div>
                  <Link
